  ...
  async  function handleCreateAd (e: FormEvent){
    ...
    return (
        <Dialog.Portal>
            ...
            <Dialog.Content className='fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-lg shadonw-black/25'>
                ...
                <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4'>
                    ...
                    <div className='grid grid-cols-2 gap-6'>
                        ...
                        <div className='flex flex-col gap-2'>
                            ...
                            <Input name='discord' id='discord' placeholder='usuario000' />
                        </div>
                    </div>
